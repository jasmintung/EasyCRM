# Generated by Django 2.1.2 on 2018-11-28 01:47
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Branch', verbose_name='校区')),
            ],
            options={
                'verbose_name': '班级列表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('from_class', models.ForeignKey(on_delete=None, to='repository.ClassList', verbose_name='班级(课程)')),
                ('teacher', models.ForeignKey(on_delete=None, to=settings.AUTH_USER_MODEL, verbose_name='讲师')),
            ],
            options={
                'verbose_name': '上课纪录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('male', '男'), ('female', '女')], default='male', max_length=32, verbose_name='u性别')),
                ...
                ('source', models.CharField(choices=[('qq', 'qq群'), ('referral', '内部转介绍'), ('website', '官方网站'), ('baidu_ads', '百度广告'), ('qq_class', '网易课堂'), ('school_propaganda', '高校宣讲'), ('51cto', '51CTO'), ('others', '其它')], default='qq', max_length=64, verbose_name='客户来源')),
                ...
                ('consultant', models.ForeignKey(on_delete=None, to=settings.AUTH_USER_MODEL, verbose_name='课程顾问')),
                ('course', models.ForeignKey(on_delete=None, to='repository.Course', verbose_name='咨询课程')),
                ('referral_from', models.ForeignKey(blank=True, help_text='若此客户是转介绍自内部学员,请在此处选择内部＼学员姓名', null=True, on_delete=None, related_name='internal_referral', to='repository.Customer', verbose_name='转介绍自学员')),
            ],
            options={
                'verbose_name': '客户信息表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultant', models.ForeignKey(on_delete=None, to=settings.AUTH_USER_MODEL, verbose_name='跟踪人')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Customer', verbose_name='所咨询客户')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('why_us', models.TextField(blank=True, default=None, max_length=1024, null=True, verbose_name='为什么选择我们?')),
                ...
                ('course_grade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.ClassList', verbose_name='所报班级')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Customer')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Branch', verbose_name='校区')),
            ],
            options={
                'verbose_name': '学员报名表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url_name', models.CharField(blank=True, max_length=128, null=True, unique=True)),
            ],
            options={
                'verbose_name': '前端菜单',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consultant', models.ForeignKey(help_text='谁签的单就选谁', on_delete=None, to=settings.AUTH_USER_MODEL, verbose_name='负责老师')),
                ('enrollment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Enrollment')),
            ],
            options={
                'verbose_name': '缴费纪录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='repository.Customer')),
            ],
            options={
                'verbose_name': '学员账户',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('attendance', models.CharField(choices=[('checked', '已签到'), ('late', '迟到'), ('noshow', '缺勤'), ('leave_early', '早退')], default='checked', max_length=64, verbose_name='上课纪录')),
                ...
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.CourseRecord', verbose_name='第几天课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Enrollment', verbose_name='学员')),
            ],
            options={
                'verbose_name': '学员学习纪录',
        ...
        migrations.AddField(
            model_name='classlist',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='repository.Course', verbose_name='课程'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
        ...
        migrations.AddField(
            ...
            name='branch',
            field=models.ForeignKey(blank=True, null=True, on_delete=None, to='repository.Branch', verbose_name='所属校区'),
        ),
        migrations.AddField(
            model_name='userprofile',
            name='groups',
        ...
        migrations.AddField(
            model_name='userprofile',
            name='roles',
            field=models.ManyToManyField(to='repository.Role', verbose_name='角色'),
        ),
        migrations.AddField(
            model_name='userprofile',
