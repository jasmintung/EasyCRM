# Generated by Django 2.1.2 on 2018-10-31 13:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='easycrmadmin.Branch', verbose_name='校区')),
            ],
            options={
                'verbose_name': '班级列表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.ForeignKey(on_delete=None, to='easycrmadmin.ClassList', verbose_name='班级(课程)')),
            ],
            options={
                'verbose_name': '上课纪录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_grade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='easycrmadmin.ClassList', verbose_name='所报班级')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='easycrmadmin.Customer')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='easycrmadmin.Branch', verbose_name='校区')),
            ],
            options={
                'verbose_name': '学员报名表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=32, unique=True)),
                ('menus', models.ManyToManyField(blank=True, to='easycrmadmin.Menu')),
            ],
            options={
                'verbose_name': '角色',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='easycrmadmin.Customer')),
            ],
            options={
                'verbose_name': '学员账户',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='easycrmadmin.CourseRecord', verbose_name='第几天课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='easycrmadmin.Customer', verbose_name='学员')),
            ],
            options={
                'verbose_name': '学员学习纪录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(blank=True, null=True, on_delete=None, to='easycrmadmin.Branch', verbose_name='所属校区')),
                ('roles', models.ManyToManyField(blank=True, to='easycrmadmin.Role')),
        ...
        migrations.AddField(
            ...
            name='consultant',
            field=models.ForeignKey(help_text='谁签的单就选谁', on_delete=None, to='easycrmadmin.UserProfile', verbose_name='负责老师'),
        ),
        migrations.AddField(
            model_name='paymentrecord',
            name='enrollment',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='easycrmadmin.Enrollment'),
        ),
        migrations.AddField(
            model_name='customerfollowup',
            name='consultant',
            field=models.ForeignKey(on_delete=None, to='easycrmadmin.UserProfile', verbose_name='跟踪人'),
        ),
        migrations.AddField(
            model_name='customerfollowup',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='easycrmadmin.Customer', verbose_name='所咨询客户'),
        ),
        migrations.AddField(
            model_name='customer',
            name='consultant',
            field=models.ForeignKey(on_delete=None, to='easycrmadmin.UserProfile', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='customer',
            name='course',
            field=models.ForeignKey(on_delete=None, to='easycrmadmin.Course', verbose_name='咨询课程'),
        ),
        migrations.AddField(
            model_name='customer',
            name='referral_from',
            field=models.ForeignKey(blank=True, help_text='若此客户是转介绍自内部学员,请在此处选择内部＼学员姓名', null=True, on_delete=None, related_name='internal_referral', to='easycrmadmin.Customer', verbose_name='转介绍自学员'),
        ),
        migrations.AddField(
            model_name='courserecord',
            name='teacher',
            field=models.ForeignKey(on_delete=None, to='easycrmadmin.UserProfile', verbose_name='讲师'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='easycrmadmin.Course', verbose_name='课程'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
            field=models.ManyToManyField(to='easycrmadmin.UserProfile', verbose_name='讲师'),
        ),
